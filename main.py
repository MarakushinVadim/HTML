    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <div class="card text-center">
                <h2 class="card-header">FAQ</h2><br>
                <div class="d-grid gap-2">
                    <button class="btn btn-dark btn-lg" data-bs-toggle="collapse" role="button" data-bs-target="#collapse1"
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <th scope="row">4</th>
                    <td><b><i>Посудомоечная машина</i></b></td>
                    <td>40000</td>
                    <td>2</td>
                    <td><b>80000</b></td>
